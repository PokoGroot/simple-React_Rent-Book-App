                ...
                <div className="row">
                    ...
                    <div className="row" style={{marginTop:'20px', height: '450px'}}>
                        ...
                        <Form style={{margin: '12px auto'}}>
                            <FormGroup>
                                <Input type="text" name="username" id="username" placeholder="Username" style={{width: '300px'}}/>
                            </FormGroup>
                            <FormGroup>
                                <Input type="text" name="fullname" id="fullname" placeholder="Full Name" style={{width: '300px'}}/>
                            </FormGroup>
                            <FormGroup>
